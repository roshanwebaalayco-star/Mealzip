...
export default function WeeklyContextPage() {
  ...
  }, [familyId, members.length, defaultBudget]);
  ...
  return (
    ...
    >
      <div className="shrink-0 px-4 pt-4 pb-2 sm:px-6 sm:pt-6 flex items-center gap-3">
        <button
          onClick={() => setLocation("/meal-plan")}
          className="w-11 h-11 rounded-xl bg-muted flex items-center justify-center hover:bg-muted/80 transition-colors"
        >
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-4 max-w-xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            >
              <SelectTrigger className="mt-1.5 h-11 rounded-xl text-sm"><SelectValue /></SelectTrigger>
              <SelectContent>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            >
              <SelectTrigger className="mt-1.5 h-11 rounded-xl text-sm"><SelectValue placeholder={t("Select", "चुनें")} /></SelectTrigger>
              <SelectContent>
      ...
      <div className="shrink-0 border-t border-border px-4 sm:px-6 py-3 bg-background">
        <div className="flex gap-3 max-w-xl mx-auto">
          <Button variant="outline" onClick={() => setLocation("/meal-plan")} className="flex-1 rounded-xl h-11" disabled={generate.isPending}>
            {t("Cancel", "रद्द करें")}
          </Button>
          <button
            onClick={submitPlan}
